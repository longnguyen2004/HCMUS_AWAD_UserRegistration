...
export function setupAssociations() {
  ...
  Models.Seat.belongsTo(Models.Bus, { foreignKey: "busId", as: "bus" });
  Models.Bus.hasMany(Models.Seat, { foreignKey: "busId", as: "seats" });
  ...
  Models.Trip.hasMany(Models.TripBusStop, {
    foreignKey: "tripId",
    as: "tripBusStops",
  });
  Models.TripBusStop.belongsTo(Models.BusStop, {
    foreignKey: "busStopId",
    as: "busStop",
  });
  Models.BusStop.hasMany(Models.TripBusStop, {
    foreignKey: "busStopId",
    as: "tripBusStops",
  });
}
